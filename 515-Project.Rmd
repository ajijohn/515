...
anova(oned_alt,oned.null,test = "Chisq")
```
For TG,LDL,HDL the effect is found to be not significant(p-value = 0.29, p-value = 0.42, and p-value = 0.99 respectively). The analysis was facilitated by ANOVA where null model included demograhics(excluding BMI),diabetic indicator and behavior. Smoking indicatir was omitted in the null model.
